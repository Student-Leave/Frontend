        ...
        resetPassword(user.token, values.id, { values }) // ส่งเฉพาะรหัสผ่านที่ต้องการเปลี่ยน
            .then((res) => {
                ...
                if (checkStudentId != values.StudentID) {
                    ...
                    toast.success('คุณทำการแก้ไขรหัสนักศึกษา กำลังออกจากระบบ');
    ...
    return (
        <section className='Account'>
                            ...
                            <div className='wrap'>
                                <div className='inputgroup'>
                                    <div className='input-box'>
                                        ...
                                        <div className='input-Login'>
                                            <FaUser /><input type='number' name='studentID' placeholder={checkStudentId} onChange={handleChangeData} /><br />
                                        </div>
                                    </div>
                                    <div className='input-box'>
                                        ...
                                        <div className='prefix'>
                                            <div>
                                                <input type="radio" id="นาย" name="prefix" value="นาย" required checked={prefix === 'นาย'} onChange={handleChangeData} />
                                                <label htmlFor="นาย">นาย</label>
                                            </div>
                                            <div>
                                                <input type="radio" id="นางสาว" name="prefix" value='นางสาว' checked={prefix === 'นางสาว'} onChange={handleChangeData} />
                                ...
                                <div className='inputgroup'>
                                    <div className='input-box'>
                                        ...
                                        <div className='input-Login'>
                                            <FaEnvelope /><input type='email' name='email' placeholder={checkEmail} onChange={handleChangeData} />
                                        </div>
                                    </div>
                                    ...
                                    <div className='input-box'>
                                        ...
                                        <div className='input-Login'>
                                            <FaPhone /><input type='number' name='phone' placeholder={checkPhone} onChange={handleChangeData} />
                                        </div>
                                    </div>
                                    <div className='input-box'>
                                        <label>หมู่เรียน</label><br />
                                        <div className='input-Login'>
                                            <FaUsersRectangle /><input type='text' name='group' placeholder={checkGroup} onChange={handleChangeData} />
                                        </div>
                                    </div>
                                    <div className='input-box'>
            ...
            <Modal show={showChangeStuID} onHide={handleCloseChangeStuID} >
                ...
                <div style={{ textAlign: 'center', margin: '2rem 0', fontSize: '18px', fontFamily: 'Prompt' }}>
                    คุณทำการแก้ไขรหัสนักศึกษา ระบบกำลังส่งคุณไปยังหน้าเข้าสู่ระบบ
                </div>
